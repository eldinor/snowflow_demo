...
export class Rift {
    ...
    private _branch(x: number, z: number, tx: number, tz: number, side: number): void {
    ...
    private _spit(x: number, z: number, tx: number, tz: number): void {

 ...
 */
export function setFrameFromDir(
    out: Float32Array, o: number,
    px: number, py: number, pz: number,
...
export function mul(
    ...
    a: Float32Array, oa: number,
    b: Float32Array, ob: number,
): void {
    for (let c = 0; c < 4; c++) {
 ...
 */
export function invertRigid(out: Float32Array, oo: number, m: Float32Array, om: number): void {
...
export function xformPoint(
    m: Float32Array, om: number,
    x: number, y: number, z: number,
    dst: Float32Array, od: number,
): void {

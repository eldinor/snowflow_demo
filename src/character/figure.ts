 ...
 */
function composeBasis(yaw:number, pitch:number, roll:number):void {
 ...
 */
function solveTwoBone(rx:number,ry:number,rz:number,tx:number,ty:number,tz:number,px:number,py:number,pz:number,l1:number,l2:number,out:Float32Array):void {
...
export class Figure {
    ...
    joint:Float32Array;
    plant:Float32Array;
    footPos:Float32Array;
    footNormal:Float32Array;
    footWeight:Float32Array;
    private _wasStance:boolean[];
    private _feetInitialized:boolean;
    touchdown:boolean[];
    hipY:number;
    pitch:number;
    roll:number;
     ...
     * @param {number} dt
     * @param {import("./controller.ts").CharacterController} ch
     */
    update(dt:number, ch:CharacterController):void {
    ...
    private _setBone(b:number,px:number,py:number,pz:number,yx:number,yy:number,yz:number,zx:number,zy:number,zz:number):void {
     ...
     */
    private _footHeight(x:number, z:number, ch:CharacterController):number {
     ...
     */
    private _updateFeet(h:number, ch:CharacterController):void {
     ...
     * wide of the hip.
     */
    private _poseLeg(f:number,rootX:number,rootY:number,rootZ:number,rX:number,rY:number,rZ:number,uX:number,uY:number,uZ:number,fX:number,fY:number,fZ:number):void {
     ...
     */
    private _poseArms(h:number,ch:CharacterController,cx:number,cy:number,cz:number,rX:number,rY:number,rZ:number,uX:number,uY:number,uZ:number,fX:number,fY:number,fZ:number):void {
        const surf = ch.surf;
    ...
    handPosition(which:number, out:Float32Array, od:number):void {

...
import { FLIGHT_DURATION, FLIGHT_COOLDOWN } from '../character/flight.js';
...
export class FlightWind {
    constructor(scene, character, spray) {
        ...
        this.label=this.hud.querySelector('span'); this.bar=this.hud.querySelector('progress');
        this.tip=this.hud.querySelector('small');
